...
architecture STRUCTURE of design_1_VideoGen_0_0_VideoGen is
  ...
  signal \led[0]__0_i_1_n_0\ : STD_LOGIC;
  signal \led[2]__0_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \CounterX[2]_i_1\ : label is "soft_lutpair1";
...
\led[0]__0_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000FF8A"
    )
        port map (
...
\led[2]__0_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000AACE"
    )
        port map (
...
\led_reg[0]__0\: unisim.vcomponents.FDRE
     port map (
      C => CLK,
      CE => '1',
      D => \led[0]__0_i_1_n_0\,
...
\led_reg[2]__0\: unisim.vcomponents.FDRE
     port map (
      C => CLK,
      CE => '1',
      D => \led[2]__0_i_1_n_0\,

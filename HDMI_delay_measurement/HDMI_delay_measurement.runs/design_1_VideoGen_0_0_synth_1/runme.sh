...
HD_PWD='C:/Github/Zybo_mipi/HDMI_delay_measurement/HDMI_delay_measurement.runs/design_1_VideoGen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_VideoGen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_VideoGen_0_0.tcl

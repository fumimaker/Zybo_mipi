...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_BayerToRGB is
  ...
  signal \jb_p_reg[4]_i_4_n_0\ : STD_LOGIC;
  ...
  signal \sCntLines_reg__0\ : STD_LOGIC_VECTOR ( 10 downto 1 );
  ...
  attribute SOFT_HLUTNM of \sAXIMasterRed[9]_i_4\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \sCntLines[1]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \sCntLines[2]_i_1\ : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of \sCntLines[6]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \sCntLines[7]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \sCntLines[8]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \sCntLines[9]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \sCntRemPixels[0]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \sCntRemPixels[1]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \sOtherPixelsData[10]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \sOtherPixelsData[11]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \sOtherPixelsData[12]_i_1\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \sOtherPixelsData[17]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \sOtherPixelsData[18]_i_1\ : label is "soft_lutpair14";
...
\jb_p_reg[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000F10000FFFF"
        ...
        port map (
      I0 => \sCntLines_reg__0\(5),
      I1 => \sCntLines_reg__0\(4),
      I2 => \jb_p_reg[4]_i_3_n_0\,
      I3 => \sCntLines_reg__0\(8),
      I4 => \sCntLines_reg__0\(10),
...
\jb_p_reg[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \sCntLines_reg__0\(2),
      I3 => \sCntLines_reg__0\(1),
      I4 => sCntLines_reg(0),
      I5 => \jb_p_reg[4]_i_4_n_0\,
...
\jb_p_reg[4]_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \sCntLines_reg__0\(3),
      I4 => \sCntLines_reg__0\(10),
      I5 => \sCntLines_reg__0\(9),
      O => \jb_p_reg[4]_i_4_n_0\
    );
...
\sCntLines[10]_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \sCntLines_reg__0\(2),
      I2 => sCntLines_reg(0),
      I3 => \sCntLines_reg__0\(1),
      I4 => \sCntLines_reg__0\(3),
...
\sCntLines[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
        ...
        port map (
      I0 => \sCntLines_reg__0\(2),
      I1 => sCntLines_reg(0),
      I2 => \sCntLines_reg__0\(1),
      I3 => \sCntLines_reg__0\(3),
      O => \plusOp__0\(3)
    );
\sCntLines[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
        ...
        port map (
      I0 => \sCntLines_reg__0\(3),
      I1 => \sCntLines_reg__0\(1),
      I2 => sCntLines_reg(0),
      I3 => \sCntLines_reg__0\(2),

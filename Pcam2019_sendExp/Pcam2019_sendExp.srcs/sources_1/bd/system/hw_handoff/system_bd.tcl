...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net AXI_GammaCorrection_0_jc_p [get_bd_ports jc_p] [get_bd_pins AXI_GammaCorrection_0/jc_p] [get_bd_pins system_ila_0/probe2]
  ...
  connect_bd_net -net rst_system_150M_peripheral_aresetn [get_bd_pins rst_system_150M/peripheral_aresetn]

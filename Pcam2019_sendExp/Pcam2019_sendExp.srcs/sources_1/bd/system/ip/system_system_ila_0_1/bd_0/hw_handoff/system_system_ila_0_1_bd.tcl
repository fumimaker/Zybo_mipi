...
proc create_root_design { parentCell } {
  ...
  set probe3 [ create_bd_port -dir I -from 4 -to 1 probe3 ]
  set probe4 [ create_bd_port -dir I -from 4 -to 1 probe4 ]
  set probe5 [ create_bd_port -dir I -from 4 -to 1 probe5 ]

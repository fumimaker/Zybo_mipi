...
proc create_root_design { parentCell } {
  ...
  set probe0 [ create_bd_port -dir I -from 4 -to 1 probe0 ]
  set probe1 [ create_bd_port -dir I -from 4 -to 1 probe1 ]
  set probe2 [ create_bd_port -dir I -from 4 -to 1 probe2 ]

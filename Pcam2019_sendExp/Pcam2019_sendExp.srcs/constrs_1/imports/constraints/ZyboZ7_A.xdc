...
#set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { udpled }]; #IO_L23N_T3_35 Sch=led[1] udpled
...
##Pmod Header JD
#set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { RSTBTN }]; #IO_L5N_T0_34 Sch=jd_n[1]
#set_property -dict { PACKAGE_PIN T14   IOSTANDARD LDVS     } [get_ports { jd[2] }]; #IO_L5P_T0_34 Sch=jd_p[1]
#set_property -dict { PACKAGE_PIN R14   IOSTANDARD LDVS     } [get_ports { jd[3] }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2]
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LDVS     } [get_ports { jd[4] }]; #IO_L6P_T0_34 Sch=jd_p[2]
#set_property -dict { PACKAGE_PIN U15   IOSTANDARD LDVS     } [get_ports { jd[5] }]; #IO_L11N_T1_SRCC_34 Sch=jd_n[3]
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LDVS     } [get_ports { jd[6] }]; #IO_L11P_T1_SRCC_34 Sch=jd_p[3]
#set_property -dict { PACKAGE_PIN V18   IOSTANDARD LDVS     } [get_ports { jd[7] }]; #IO_L21N_T3_DQS_34 Sch=jd_n[4]
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LDVS     } [get_ports { jd[8] }]; #IO_L21P_T3_DQS_34 Sch=jd_p[4]

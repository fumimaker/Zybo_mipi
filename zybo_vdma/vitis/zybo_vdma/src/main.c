...
void VdmaInit(void){
	...
	myFrameBuffer.VertSizeInput = v_res;		// 720 vertical pixels.
	myFrameBuffer.HoriSizeInput = h_res * 4; // 1280 horizontal (32-bit pixels).
	myFrameBuffer.Stride = h_res * 4;		// Dont' worry about the rest of the values.
	myFrameBuffer.FrameDelay = 0;
	myFrameBuffer.EnableCircularBuf = 0;//1
	myFrameBuffer.EnableSync = 0;
	myFrameBuffer.PointNum = 0;
	myFrameBuffer.EnableFrameCounter = 0;
	myFrameBuffer.FixedFrameStoreAddr = 2;//0

	myFrameBuffer.FrameStoreStartAddr[0] = 0xA0000000;
	myFrameBuffer.FrameStoreStartAddr[1] = 0xA1000000;
	myFrameBuffer.FrameStoreStartAddr[2] = 0xA2000000;
	...
	ReadFrameBuffer.FrameDelay = 0; //0
	ReadFrameBuffer.EnableCircularBuf = 0;//0
	ReadFrameBuffer.EnableSync = 0;//1
	ReadFrameBuffer.PointNum = 0;
	ReadFrameBuffer.EnableFrameCounter = 0; 
	ReadFrameBuffer.FixedFrameStoreAddr = 2; //0   park it on 0 until we sync

	ReadFrameBuffer.FrameStoreStartAddr[0] = 0xA0000000;
	ReadFrameBuffer.FrameStoreStartAddr[1] = 0xA1000000;
	ReadFrameBuffer.FrameStoreStartAddr[2] = 0xA2000000;

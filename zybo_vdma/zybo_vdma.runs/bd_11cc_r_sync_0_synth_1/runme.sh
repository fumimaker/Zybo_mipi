...
HD_PWD='C:/Github/Zybo_mipi/zybo_vdma/zybo_vdma.runs/bd_11cc_r_sync_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_11cc_r_sync_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_11cc_r_sync_0.tcl

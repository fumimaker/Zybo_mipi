...
//--------------------------------------------------------------------------------
//Command: generate_target bd_11cc.bd
//Design : bd_11cc
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_11cc,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_11cc,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1_mipi_csi2_rx_subsyst_0_1.hwdef" *) 
module bd_11cc
   (csirxss_csi_irq,
  ...
  assign video_out_tdata[63:0] = vfb_0_m_vfb_TDATA;
